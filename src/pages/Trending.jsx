            ...
            <div className='w-full bg-[#10141e] md:p-10 mb-20 md:mb-0'>
                ...
                {!loader && trending.length > 0 && (
                    <div className="flex flex-col items-center mt-8 space-y-4">
                        ...
                        <div className="text-gray-400 text-sm text-center flex items-center space-x-2">
                            ...
                            <span>Page {page} of {totalPage} • {trending.length} trending movies loaded</span>
                        </div>
                ...
                {!loader && trending.length === 0 && (
                    <div className="text-center py-10">
                        <div className="text-gray-400 text-lg mb-2">No trending movies found</div>
                        <div className="text-gray-500 text-sm">Check back later for the latest trending content</div>
                    </div>
                )}
            </div>
        </>
